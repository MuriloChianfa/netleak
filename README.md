...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/L2TP%2FIPSec-6B4C9A?style=for-the-badge" alt="L2TP/IPSec">
</p>
...
<details name="install" open>
  ...
  ```bash
  curl -LO https://github.com/MuriloChianfa/netleak/releases/download/v1.1.1/netleak_1.1.1_amd64_ubuntu-24.04-amd64.deb
  sudo dpkg -i netleak_1.1.1_amd64_ubuntu-24.04-amd64.deb
  ```
</details>
<details name="install">
  ...
  ```bash
  curl -LO https://github.com/MuriloChianfa/netleak/releases/download/v1.1.1/netleak-1.1.1-1.fc40.x86_64_fedora-40-x86_64.rpm
  sudo rpm -i netleak-1.1.1-1.fc40.x86_64_fedora-40-x86_64.rpm
  ```
</details>
